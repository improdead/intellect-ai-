...
import { AnimatePresence, type AnimatePresenceProps, motion, type MotionProps, type Transition } from "framer-motion"
...
const TextRotate = forwardRef<TextRotateRef, TextRotateProps>(
  (
    ...
    return (
      <motion.span
        className={`flex flex-wrap whitespace-pre-wrap ${mainClassName || ""}`}
        {...props}
        layout
        transition={transition}
      >
        ...
        <AnimatePresence mode={animatePresenceMode} initial={animatePresenceInitial}>
          <motion.div
            ...
            className={`flex flex-wrap ${splitBy === "lines" ? "flex-col w-full" : ""}`}
            layout
            aria-hidden="true"
          >
            {(splitBy === "characters"
